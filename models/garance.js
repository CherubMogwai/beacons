export default class Garance {
  ...
  where_alice() {
    ...
    var R = 6371e3; // metres
    var φ = this.lat * Math.PI / 180;
    var gar_φ = alice.lat * Math.PI / 180;
    var gar_Δφ = (this.lat - alice.lat) * Math.PI / 180;
    var gar_Δλ = (alice.lng - this.lng) * Math.PI / 180;
    ...
    console.log(["Alice =", gar_q, "meters"]);
